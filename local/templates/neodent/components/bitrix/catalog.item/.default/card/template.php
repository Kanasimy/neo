...
?>
    ...
    <picture>
      ...
      <img src="<?=$item['PREVIEW_PICTURE']['SRC']?>" alt="<?=$item["NAME"]?>" title="<?=$item["NAME"]?>" width="100%" loading="lazy"/>
    </picture>
		<?
		if ($item['SECOND_PICT'])
		{
	...
	<? endif; ?>
		...
		<? if ($itemHasDetailUrl): ?>
		<a class="popular__link" href="<?=$item['DETAIL_PAGE_URL']?>" title="<?=$productTitle?>">
		<? endif; ?>
		<?=$productTitle?>
		<? if ($itemHasDetailUrl): ?>
		</a>
...
<div class="popular__buy">
	...
	if (!empty($arParams['PRODUCT_BLOCKS_ORDER']))
	{
		foreach ($arParams['PRODUCT_BLOCKS_ORDER'] as $blockName)
		{
			...
			{
				case 'price': ?>
          <div class="popular__price" data-entity="price-block">
						<?
