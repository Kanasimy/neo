...
?>
	...
	<? if ($itemHasDetailUrl): ?>
	<a class="product-item-image-wrapper catalog__image-wrapper" href="<?=$item['DETAIL_PAGE_URL']?>" title="<?=$imgTitle?>"
    ...
    <picture>
      <source srcset="<?=$item['PREVIEW_PICTURE']['SRC']?>" />
      <img class="catalog__image" src="<?=$item['PREVIEW_PICTURE']['SRC']?>" alt="<?=$item["NAME"]?>" title="<?=$item["NAME"]?>" loading="lazy"/>
    </picture>
		<?
		if ($item['SECOND_PICT'])
		{
	...
	<? endif; ?>
		...
		<? if ($itemHasDetailUrl): ?>
		<a class="catalog__link" href="<?=$item['DETAIL_PAGE_URL']?>" title="<?=$productTitle?>">
		<? endif; ?>
		<?=$productTitle?>
		<? if ($itemHasDetailUrl): ?>
		</a>
			...
			switch ($blockName)
			{
				...
				case 'quantityLimit':
					if ($arParams['SHOW_MAX_QUANTITY'] !== 'N')
					{
						if ($haveOffers)
						{
							...
							{
								?>
								<div class="product-item-info-container product-item-hidden visually-hidden" id="<?=$itemIds['QUANTITY_LIMIT']?>"
				...
				case 'quantity':
					if (!$haveOffers)
					{
						...
						{
							?>
							<div class="product-item-info-container product-item-hidden visually-hidden" data-entity="quantity-block">
					...
					elseif ($arParams['PRODUCT_DISPLAY_MODE'] === 'Y')
					{
						...
						{
							?>
							<div class="product-item-info-container product-item-hidden vngisually-hidden" data-entity="quantity-block">
								<div class="product-item-amount">
									<div class="product-item-amount-field-container">
										<span class="product-item-amount-field-btn-minus no-select" id="<?=$itemIds['QUANTITY_DOWN']?>"></span>
										<input class="product-item-amount-field" id="<?=$itemIds['QUANTITY']?>" type="number"
							...
							if ($actualItem['CAN_BUY'])
							{
								...
								<div class="product-item-button-container" id="<?=$itemIds['BASKET_ACTIONS']?>">
									<a class="btn btn-default <?=$buttonSizeClass?>" id="<?=$itemIds['BUY_LINK']?>"
										...
										<?=($arParams['ADD_TO_BASKET_ACTION'] === 'BUY' ? "Купить" : $arParams['MESS_BTN_ADD_TO_BASKET'])?>
									</a>
								</div>
								<?
							}
