...
$buyButtonClassName = in_array('BUY', $arParams['ADD_TO_BASKET_ACTION_PRIMARY']) ? 'btn--buy' : 'btn--cart';
$showAddBtn = in_array('ADD', $arParams['ADD_TO_BASKET_ACTION']);
$showButtonClassName = in_array('ADD', $arParams['ADD_TO_BASKET_ACTION_PRIMARY']) ? 'btn--buy' : 'btn--cart';
...
<div class="bx-catalog-element bx-<?=$arParams['TEMPLATE_THEME']?>" id="<?=$itemIds['ID']?>"
	...
	<div class="container-fluid">
		...
		if ($arParams['DISPLAY_NAME'] === 'Y')
		{
			...
			<div class="row">
				<div class="col-xs-12">
					<h1 class="product-item__title"><?=$name?></h1>
				</div>
			</div>
			<?
		}
                      ...
                      Цена:
												...
												<div class="product-item-amount">
													<div class="product-item-amount-field-container">
														...
														<span class="product-item-amount-description-container">
															<span class="visually-hidden" id="<?=$itemIds['QUANTITY_MEASURE']?>">
									...
									case 'buttons':
										...
										<div data-entity="main-button-container">
											<div class="product-item__btn-container" id="<?=$itemIds['BASKET_ACTIONS_ID']?>" style="display: <?=($actualItem['CAN_BUY'] ? '' : 'none')?>;">
                        <div class="product-item-detail-info-container">
                  ...
                  case 'props':?>
                    <?if (!empty($arResult['DISPLAY_PROPERTIES']) || $arResult['SHOW_OFFERS_PROPS'])
                    {
                      ...
                      <div class="product-item-detail-info-container">
                        ...
                        {
                          ?>
                          <!--pre><? //print_r($arResult['DISPLAY_PROPERTIES']) ?></pre-->
...
?>
<h3 style="margin-bottom:-50px">Похожие товары</h3>
<?
$APPLICATION->IncludeComponent(
