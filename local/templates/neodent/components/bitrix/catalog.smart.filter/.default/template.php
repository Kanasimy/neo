	...
	<div class="bx-filter-section container-fluid">
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
			...
			<div class="row">
				<?foreach($arResult["ITEMS"] as $key=>$arItem)//prices
				{
						...
						<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> bx-filter-parameters-box bx-active">
							...
							<div class="bx-filter-block" data-role="bx_filter_block">
								<div class="row bx-filter-parameters-box-container">
									<div class="col-md-6 bx-filter-parameters-box-container-block bx-left">
                    <div class="bx-filter-input-container">
									...
									<div class="col-md-6 bx-filter-parameters-box-container-block bx-right">
                    <div class="bx-filter-input-container">
            ...
            <div class="col-xs-12 availability">
              <div class="checkbox">
                <?
                $_REQUEST = \Bitrix\Main\Context::getCurrent()->getRequest()->getQueryList()->toArray();
                ?>
<!--<pre>-->
<!--1 get --><?//echo $_REQUEST['HIDE_NOT_AVAILABLE']?>
<!--</pre>-->
<script>
$(document).ready(function() {
  $("#catalog_available").change(function (e) {
    if ($(this).is(":checked")) {
      window.location.search = "HIDE_NOT_AVAILABLE=Y";
    } else {
      const url = new URL(document.location);
      const searchParams = url.searchParams;
      searchParams.delete("HIDE_NOT_AVAILABLE");
      window.location=url;
    }
  });
});
</script>
                <input type="checkbox" id="catalog_available" class="checkbox__input" name="HIDE_NOT_AVAILABLE" <?
                if($_REQUEST[HIDE_NOT_AVAILABLE]=='Y') echo 'checked="checked"'?> value="Y" id="catalog_available" />
                <label data-role="label_arrFilter_" class="bx-filter-param-label checkbox__label " for="catalog_available">
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> bx-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
                        ...
                        <input
                          ...
                          onclick="smartFilter.click(this)"
                        />
												<label data-role="label_<?=$ar["CONTROL_ID"]?>" class="bx-filter-param-label checkbox__label <? echo $ar["DISABLED"] ? 'disabled': '' ?>" for="<? echo $ar["CONTROL_ID"] ?>">
												<span class="bx-filter-param-text" title="<?=$ar["VALUE"];?>"><?=$ar["VALUE"];?><?
                          if ($arParams["DISPLAY_ELEMENT_COUNT"] !== "N" && isset($ar["ELEMENT_COUNT"])):
                            ?>&nbsp;(<span data-role="count_<?=$ar["CONTROL_ID"]?>"><? echo $ar["ELEMENT_COUNT"]; ?></span>)<?
                          endif;?></span>
