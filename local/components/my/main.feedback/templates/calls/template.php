...
<div class="p-4">
    ...
    <div class="mb-3">
      <label for="mainFeedback_phone" class="form-label"><?=GetMessage("MFT_PHONE")?><?
        if(empty($arParams["REQUIRED_FIELDS"]) || in_array("PHONE", $arParams["REQUIRED_FIELDS"])):?><span class="mf-control-required">*</span><?endif?></label>
      <input
        type="phone"
        name="user_phone"
